...
/**
 * Shape and mapping version of the emitted records, surfaced in the app.
 * Bump it when the record fields or the placarding rules below change — it
 * answers "which build of this data am I looking at", which `cfrDate` cannot,
 * since cfrDate tracks the source text and moves on its own schedule.
 */
